...
1. **`docs/ai-reporting/reference/presentation-contract.md`** — update the chart portion. Keep the
...
- `docs/ai-reporting/reference/presentation-contract.md` states the four behaviour changes above.
- A changeset file exists and names the affected packages with minor bumps.

## Files

- `docs/ai-reporting/reference/presentation-contract.md` — modify.
- `.changeset/*.md` — create.
