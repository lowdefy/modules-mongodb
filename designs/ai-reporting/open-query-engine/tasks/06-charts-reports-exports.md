...
**Update `modules/ai-reporting/api/`:**
...
- `modules/ai-reporting/api/render-chart.yaml`, `generate-report.yaml`, `export-data.yaml`, `resolve-report.yaml`, `emit-data-parts.yaml` — modify
