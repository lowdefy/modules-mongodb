...
**Catalog reference** (`docs/ai-reporting/reference/catalog.md` or fold into the concept page if short — prefer a separate reference page):
...
- `docs/ai-reporting/concepts/open-query-engine.md` — create
- `docs/ai-reporting/reference/catalog.md` — create
- `docs/ai-reporting/how-to/complex-data.md` — modify
- `docs/ai-reporting/index.md` — modify — link the new pages, update the module summary
