...
**`modules/ai-reporting/api/list-conversations.yaml`:**
...
**Create `modules/ai-reporting/api/delete-conversation.yaml`**, on `delete-report.yaml`'s shape:
...
**`modules/ai-reporting/module.lowdefy.yaml`:** add `- _ref: api/delete-conversation.yaml` to
...
- `modules/ai-reporting/api/list-conversations.yaml` — modify — soft-delete filter, cap 200
- `modules/ai-reporting/api/delete-conversation.yaml` — create
- `modules/ai-reporting/module.lowdefy.yaml` — modify — the `api:` `_ref`
