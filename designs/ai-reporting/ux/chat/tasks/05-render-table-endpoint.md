...
**Create `modules/ai-reporting/api/render-table.yaml`**, mirroring `modules/ai-reporting/api/render-chart.yaml`
...
**`modules/ai-reporting/module.lowdefy.yaml`:** add `- _ref: api/render-table.yaml` to `api:`,
...
- `modules/ai-reporting/api/render-table.yaml` — create
