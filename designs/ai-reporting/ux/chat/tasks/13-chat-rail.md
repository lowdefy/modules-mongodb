...
All in `modules/ai-reporting/pages/chat.yaml`, inside `conversations_panel`.
...
- `modules/ai-reporting/pages/chat.yaml` — modify — search, grouping, the item menu, rename and
  delete
- `modules/ai-reporting/pages/chat/actions/*.yaml` — create, if the shared refetch is extracted
