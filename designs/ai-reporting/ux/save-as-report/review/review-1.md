...
"New `modules/ai-reporting/pages/components/save_report_sheet.yaml` — the confirm sheet, opened
...
Consequences if it becomes a page: a new `modules/ai-reporting/pages/save-report.yaml` with a
kebab-case page id, a page export in `module.lowdefy.yaml`, the parent's plate table and
`docs/ai-reporting/index.md`'s surfaces table updated, deviation recorded against plate 3, and
