...
`designs/ai-reporting/ux/save-as-report/filter-picker/design.md`: an add-only picker in the
...
**Source:** `designs/ai-reporting/ux/save-as-report/filter-picker/design.md`
**Context read:** `design.md`; source: `create-report.yaml`, `validateReportSpec.js`, `querySections.js`, `analyticsOperator.js`, `constants.js`, `save_report_sheet.yaml`, `apps/demo/modules/ai-reporting/catalog.yaml`, `docs/ai-reporting/how-to/save-as-report.md`
