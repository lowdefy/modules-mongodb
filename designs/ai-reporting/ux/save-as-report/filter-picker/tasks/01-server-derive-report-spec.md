...
The catalog shape the pass reads (`apps/demo/modules/ai-reporting/catalog.yaml`):
...
### 3. Wire into `create-report` — `modules/ai-reporting/api/create-report.yaml`
...
- `modules/ai-reporting/api/create-report.yaml` — modify — derive-before-validate step; payloadSchema comment.
