...
- **Consumes:** every endpoint from tasks 3–8, the fixtures from task 9, and `callEndpoint` / `reportDoc` / `SPEC` from `apps/demo/e2e/ai-reporting/helpers.js` (task 3).

## Task

### 1. `apps/demo/e2e/ai-reporting/report-publish-lifecycle.spec.js`
...
- `apps/demo/e2e/ai-reporting/report-publish-lifecycle.spec.js` — create
