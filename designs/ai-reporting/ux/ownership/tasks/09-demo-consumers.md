...
The demo module entry lives at `apps/demo/modules.yaml:68-80`, with its vars in `apps/demo/modules/ai-reporting/vars.yaml`.
...
- `apps/demo/modules/ai-reporting/vars.yaml` — modify — `share_roles`
...
- `apps/demo/modules/ai-reporting/vars.yaml` and any demo auth config touched for the two-user role setup — modify
