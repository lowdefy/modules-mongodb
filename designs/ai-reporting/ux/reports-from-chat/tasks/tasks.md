...
Implements [`designs/ai-reporting/ux/reports-from-chat/design.md`](../design.md) — **Option B**: a
...
**Source:** `designs/ai-reporting/ux/reports-from-chat/design.md`
**Context read:** `design.md`, `wireframes.html` (referenced), `docs/ai-reporting/` layout,
