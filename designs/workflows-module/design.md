...
| 36  | [extra-action-buttons](parts/36-extra-action-buttons/design.md)                                   | [action-authoring § Decision 8 — Per-page chrome](../workflows-module-concept/action-authoring/design.md) + [ui § Decision 4 — Why fixed names](../workflows-module-concept/ui/design.md)  | S    |
