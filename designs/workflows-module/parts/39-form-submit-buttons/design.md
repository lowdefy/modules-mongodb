...
- [Part 38 — Engine rebuild](../_completed/38-engine-rebuild/design.md) — the signal contract, `makeWorkflowApis` emitting `signal`, demo config migration. This part depends on its endpoint contract.
