...
**Resolution:** Corrected to "four operational APIs" with the actual four names. Removed the spurious "build-time validator hooks for `vars.entities`" bullet that didn't belong there — that validator is part 4's obligation per [part 17 design.md line 96](../../_completed/17-shared-pages/design.md).
