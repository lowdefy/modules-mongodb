...
- [Part 46 — Debundle workflow config](../_completed/46-debundle-workflow-config/design.md) — D1 here narrows its D3 (structure stays, render leaves); D7 there is the dynamic-config future this bridges toward.
