...
| [Part 24 (universal-fields)](../../_next/24-universal-fields/design.md)                                                                                              | Open question on "who can edit metadata" resolves through this part's per-verb shape (a future `update_metadata` signal maps to its own required verb if needed). Re-open under Part 24 once this lands.                                                                                                                                                                                                                                                                                                                                                                                                          |
...
- **[Part 24 (universal-fields)](../../_next/24-universal-fields/design.md)** — write-surface decision depends on this part's shape.
