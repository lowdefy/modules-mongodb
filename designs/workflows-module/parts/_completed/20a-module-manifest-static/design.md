...
Split from the original Part 20. This half lands the manifest entries that do **not** depend on the upstream Lowdefy extensions in [part 01 (`callApi`)](modules-mongodb/designs/workflows-module/parts/01-call-api-primitive/design.md) or [part 02 (dynamic module page exports)](modules-mongodb/designs/workflows-module/parts/02-dynamic-module-pages/design.md), plus a tracker-only worked-example wiring that exercises the static surface end-to-end. The dynamic resolver-emitted exports — per-action pages from [part 12](modules-mongodb/designs/workflows-module/parts/_completed/12-resolver-pages/design.md) and per-action submit endpoints from [part 13](modules-mongodb/designs/workflows-module/parts/_completed/13-resolver-apis/design.md) — land in [part 20b](modules-mongodb/designs/workflows-module/parts/_completed/20b-module-manifest-dynamic/design.md).
...
This half adds everything in `module.lowdefy.yaml` *except* the two resolver-channel entries that depend on [part 02](modules-mongodb/designs/workflows-module/parts/02-dynamic-module-pages/design.md).
...
The original Part 20 wired the four-action worked example verbatim from the [concept worked example](modules-mongodb/designs/workflows-module-concept/design.md#worked-example--end-to-end-across-all-seven-sub-designs) — one action per kind, including `kind: form` and `kind: task`. Form actions need resolver-emitted pages (part 12) and resolver-emitted submit endpoints (part 13); task actions need the per-action endpoint to drive `task-edit`'s save. Both require [part 02](modules-mongodb/designs/workflows-module/parts/02-dynamic-module-pages/design.md).
...
Does **not** depend on parts [01](modules-mongodb/designs/workflows-module/parts/01-call-api-primitive/design.md), [02](modules-mongodb/designs/workflows-module/parts/02-dynamic-module-pages/design.md), [12](modules-mongodb/designs/workflows-module/parts/_completed/12-resolver-pages/design.md), [13](modules-mongodb/designs/workflows-module/parts/_completed/13-resolver-apis/design.md), [14](../14-form-components-library/design.md), [15](../15-resolver-form-builder/design.md), [16](modules-mongodb/designs/workflows-module/parts/_completed/16-page-templates/design.md), [24](modules-mongodb/designs/workflows-module/parts/24-universal-fields/design.md), or [28](modules-mongodb/designs/workflows-module/parts/28-custom-action-kind/design.md). Those land via [part 20b](modules-mongodb/designs/workflows-module/parts/_completed/20b-module-manifest-dynamic/design.md) or are independent of this manifest split.
...
- **Skeleton `makeActionPages` / `makeWorkflowApis` resolvers.** Skip. Pre-registering no-op resolvers would require [part 02](modules-mongodb/designs/workflows-module/parts/02-dynamic-module-pages/design.md)'s resolver channel shape, which is the very dependency this split is built to avoid. The resolver-channel entries land cleanly in [part 20b](modules-mongodb/designs/workflows-module/parts/_completed/20b-module-manifest-dynamic/design.md) alongside the resolvers themselves.
