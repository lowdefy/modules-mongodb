...
The `event:` block stays as a build-time override (out of scope for Part 32; tracked under [Part 33](designs/workflows-module/parts/_completed/33-comment-rendering/design.md)). Do not touch the four-layer event-override prose or the `action.event:` documentation.
