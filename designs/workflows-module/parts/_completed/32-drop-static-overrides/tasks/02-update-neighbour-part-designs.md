...
The `event:` block stays as a build-time override channel — out of scope for Part 32, tracked under [Part 33](designs/workflows-module/parts/_completed/33-comment-rendering/design.md). Do not touch any prose describing the event-overrides merge or the `event_overrides:` endpoint literal.
