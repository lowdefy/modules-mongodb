...
**This task is blocked on part 2.** Part 2's design ([parts/02-dynamic-module-pages/design.md](../../02-dynamic-module-pages/design.md)) lists "whether `exports.api` rides on the same channel as `exports.pages`" as an open question. Until that resolves, there's no manifest shape to write against. Three candidate shapes:
