...
| `apps/demo/modules/notifications/*` (send_routine config) | Superseded — see [`designs/demo-notifications/design.md`](../../../../demo-notifications/design.md). |
