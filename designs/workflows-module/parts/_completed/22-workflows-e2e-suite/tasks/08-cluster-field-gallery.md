...
- Keep Spec B to the six representatives. Per-component behavior matrices are exactly what the design forbids; if a field's _logic_ looks untested, that's a jest gap (Principle 4), not a Playwright case.
