...
| 2   | [dynamic-module-pages](parts/02-dynamic-module-pages/design.md) | S    | upstream `@lowdefy/build` (or module loading) | ✅ shipped (resolved by removing `exports:` entirely — see part 02's design.md) |
