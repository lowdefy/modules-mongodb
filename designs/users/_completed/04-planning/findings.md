...
> **Superseded by the auth-testing campaign.** This is a historical triage snapshot,
> retained because completed designs cite it for provenance. Still-open items are now tracked
> live in [`../auth-testing/findings/`](../../auth-testing/findings/index.md) (F2, F10, F30); new
> findings go there, not here. F21/F22 shipped in `../_completed/2fa-enrolment-modal`; F29 is
> owned by `../role-editing`.
