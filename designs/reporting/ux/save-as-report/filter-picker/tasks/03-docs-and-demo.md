...
The save-as-report how-to is `docs/reporting/how-to/save-as-report.md`. It currently carries a
...
In `docs/reporting/how-to/save-as-report.md`, replace the "not authorable today" note with a
...
(`apps/demo/modules/reporting/catalog.yaml`) already seeds a `demo_activities.company_ids` →
...
- `docs/reporting/how-to/save-as-report.md` no longer claims filters are un-authorable; it
...
- `docs/reporting/how-to/save-as-report.md` — modify — replace the stale filters note with the
