...
**Create `modules/reporting/pages/chat/components/save_report_sheet.yaml`** — a one-block
...
- `modules/reporting/pages/chat/components/save_report_sheet.yaml` — create — the confirm sheet.

## Notes

- **Path deviation from the design:** design.md line 83 says
  `modules/reporting/pages/components/save_report_sheet.yaml`, but every existing chat component
