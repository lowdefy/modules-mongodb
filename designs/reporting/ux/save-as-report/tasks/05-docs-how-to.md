...
live under `docs/reporting/` with `index.md`, `concepts/`, `how-to/`, and `reference/`. This task
...
Add a how-to page **`docs/reporting/how-to/save-as-report.md`** covering:
...
`docs/reporting/index.md` where the module's how-tos are listed.

Do **not** hand-edit generated files (`docs/reporting/reference/vars.md`, `docs/llms.txt`). If any
manifest var changed (none is expected in this feature), run `pnpm docs:gen` instead.

## Acceptance Criteria

- `docs/reporting/how-to/save-as-report.md` exists with valid front-matter and covers: what the
...
- It is linked from `docs/reporting/index.md`.
- `pnpm docs:check` passes (front-matter valid, no generated-file drift).

## Files

- `docs/reporting/how-to/save-as-report.md` — create — the how-to.
- `docs/reporting/index.md` — modify — link the new how-to.
