...
updating (design's Files changed, `docs/reporting/`):

- `docs/reporting/index.md` — the surfaces table (the report page's row: it now shows provenance,
  per-section export, owner recoveries, the withheld distinction, and co-located filters).
- `docs/reporting/concepts/implementation-walkthrough.md` — the compiled shape: the provenance
...
1. Update the surfaces table row for the report page in `docs/reporting/index.md` to reflect the
...
2. Update `docs/reporting/concepts/implementation-walkthrough.md` where it describes the compiled
...
- `docs/reporting/index.md` — modify: report-page surfaces row.
- `docs/reporting/concepts/implementation-walkthrough.md` — modify: compiled-shape description.
