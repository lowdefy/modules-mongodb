...
### `modules/reporting/api/set-report-title.yaml`
...
### `modules/reporting/api/restore-report.yaml`
...
Register both endpoints in `modules/reporting/module.lowdefy.yaml` — a `_ref` under `api:` and an `exports.api` entry each.

## Acceptance Criteria

`apps/demo/e2e/reporting/report-title-restore.spec.js`:
...
- `modules/reporting/api/set-report-title.yaml` — create
- `modules/reporting/api/restore-report.yaml` — create
- `modules/reporting/module.lowdefy.yaml` — modify — two `_ref`s under `api:` and two `exports.api` entries
- `apps/demo/e2e/reporting/report-title-restore.spec.js` — create
