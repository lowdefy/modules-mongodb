...
- **Consumes:** the readable-report predicate as spelled in `modules/reporting/api/resolve-report.yaml` (task 3); the document shape from task 3; `defaults/owner.yaml` and `defaults/change_stamp.yaml`.
...
### `modules/reporting/api/set-report-favourite.yaml`
...
### `modules/reporting/api/duplicate-report.yaml`
...
Register both endpoints in `modules/reporting/module.lowdefy.yaml`.

## Acceptance Criteria

`apps/demo/e2e/reporting/report-favourite-duplicate.spec.js`:
...
- `modules/reporting/api/set-report-favourite.yaml` — create
- `modules/reporting/api/duplicate-report.yaml` — create
- `modules/reporting/module.lowdefy.yaml` — modify — two `_ref`s under `api:` and two `exports.api` entries
- `apps/demo/e2e/reporting/report-favourite-duplicate.spec.js` — create
