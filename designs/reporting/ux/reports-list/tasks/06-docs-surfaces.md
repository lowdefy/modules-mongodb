...
`docs/` is the source of truth for consumer-observable behaviour. `docs/reporting/index.md` carries
...
1. In `docs/reporting/index.md`, update the **`reports-list`** row of the pages/surfaces table to
...
- `docs/reporting/index.md` — modify — the `reports-list` row and a new `reports-deleted` row.
