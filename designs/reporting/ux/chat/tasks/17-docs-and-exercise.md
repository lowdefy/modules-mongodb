...
`docs/` is the source of truth for consumer-observable authoring behaviour. `docs/reporting/index.md`
...
- `docs/reporting/index.md` — update the `chat` row of the surfaces table: the panel now holds
...
- Check `docs/reporting/reference/presentation-contract.md` for whether the table contract's
...
- `docs/reporting/index.md` — modify — the surfaces table
- `docs/reporting/reference/presentation-contract.md` — modify, if it claims the table contract is
  report-only
