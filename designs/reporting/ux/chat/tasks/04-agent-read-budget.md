...
**Create `modules/reporting/api/query-data-tool.yaml`** — the agent's read path.
...
- `modules/reporting/api/query-data-tool.yaml` — create
- `modules/reporting/module.lowdefy.yaml` — modify — the `api:` `_ref`, the `query-data`
  description
