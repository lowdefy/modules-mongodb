...
`modules/reporting/agents/reporting-assistant.yaml` holds the whole agent contract: a
...
- `modules/reporting/agents/reporting-assistant.yaml` — modify — `render_table` wiring,
