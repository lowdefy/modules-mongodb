...
`modules/reporting/pages/chat.yaml` is a `Box` with `layout: { gap: 16 }` and three child boxes
...
- `modules/reporting/pages/chat.yaml` — modify — widths, both collapses, panel visible-when-empty,
