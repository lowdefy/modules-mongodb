...
**Create `modules/reporting/pages/chat/components/saved_from_chat.yaml`** — a single `Box` section
...
In `modules/reporting/pages/chat.yaml`, add `- _ref: pages/chat/components/saved_from_chat.yaml`
...
- `modules/reporting/pages/chat/components/saved_from_chat.yaml` — create.
- `modules/reporting/pages/chat.yaml` — modify — `_ref` the section; add `saved_reports` to the
