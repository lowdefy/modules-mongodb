...
- **Modifies:** `modules/reporting/pages/chat/components/save_report_sheet.yaml` `onOk`.
...
- `modules/reporting/pages/chat/components/save_report_sheet.yaml` — modify — drop the `Link`;
