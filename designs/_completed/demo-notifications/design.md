...
This supersedes [Part 45 task 06](06-notifications-send-routine.md) (one wired notification), widening its scope to the invite mocks, the production doc schema, and the enums global.
...
- Supersedes: [workflows-module Part 45, task 06](06-notifications-send-routine.md); extends Part 45 design item 9.
