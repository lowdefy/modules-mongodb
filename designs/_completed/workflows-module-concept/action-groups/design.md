...
1. App page's template-shipped `submit` button on the `onboarding-send-quote-edit` page calls `workflows/onboarding-send-quote-submit` (resolver-generated per submit-pipeline Decision 2) with `signal: submit`.
