...
modules:
  ...
  - id: layout
    source: "github:lowdefy/modules-mongodb/modules/layout@v0.7.0"
  ...
  - id: user-account
    source: "github:lowdefy/modules-mongodb/modules/user-account@v0.7.0"
    vars:
      app_name: my-app

  - id: notifications
    source: "github:lowdefy/modules-mongodb/modules/notifications@v0.7.0"
    vars:
      app_name: my-app
```
