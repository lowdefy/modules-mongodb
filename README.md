...
modules:
  ...
  - id: layout
    source: "github:lowdefy/modules-mongodb/modules/layout@v0.39.1"

  - id: user-account
    source: "github:lowdefy/modules-mongodb/modules/user-account@v0.39.1"
    vars:
      app_name: my-app

  - id: notifications
    source: "github:lowdefy/modules-mongodb/modules/notifications@v0.39.1"
    vars:
      app_name: my-app
```
