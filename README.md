...
modules:
  - id: events
    source: "github:lowdefy/modules-mongodb/modules/events@v0.5.2"
    vars:
      display_key: my-app

  - id: layout
    source: "github:lowdefy/modules-mongodb/modules/layout@v0.5.2"
  ...
  - id: user-account
    source: "github:lowdefy/modules-mongodb/modules/user-account@v0.5.2"
    vars:
      app_name: my-app
