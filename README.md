...
modules:
  - id: events
    source: "github:lowdefy/modules-mongodb/modules/events@v0.4.0"
    vars:
      display_key: my-app

  - id: layout
    source: "github:lowdefy/modules-mongodb/modules/layout@v0.4.0"
  ...
  - id: notifications
    source: "github:lowdefy/modules-mongodb/modules/notifications@v0.4.0"
    vars:
      app_name: my-app
```
