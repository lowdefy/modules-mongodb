 ...
 *   (Start's child link fields — `child_workflow_id`,
 *   `child_entity: { connection_id, id }`, task 17); forwarded into
 ...
 * @param {Object} [args.audit] — opaque request-context bag for change-log fields.
