...
test('form kind uses derived per-action page ids', () => {
  ...
  expect(links.demo.view.pageId).toBe('workflows/installation-install-verify-view');
  expect(links.demo.edit.pageId).toBe('workflows/installation-install-verify-edit');
});
