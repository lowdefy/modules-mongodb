...
|---|---|---|
| [`ActionSteps`](src/blocks/ActionSteps/README.md) | `display` | Antd `Steps` view of grouped actions — each step is an action group with badged, optionally linked sub-actions and a rolled-up status. |
