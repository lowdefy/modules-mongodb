...
modules:
  - id: contacts
    source: "github:lowdefy/modules-mongodb/modules/contacts@v0.36.0"
    vars:
      fields:
        show_honorific: true
        profile:
