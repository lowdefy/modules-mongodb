...
modules:
  - id: events
    source: "github:lowdefy/modules-mongodb/modules/events@v0.23.1"
    vars:
      display_key: my-app

  - id: layout
    source: "github:lowdefy/modules-mongodb/modules/layout@v0.23.1"
  ...
  - id: user-account
    source: "github:lowdefy/modules-mongodb/modules/user-account@v0.23.1"
    vars:
      app_name: my-app

  - id: notifications
    source: "github:lowdefy/modules-mongodb/modules/notifications@v0.23.1"
    vars:
      app_name: my-app
```
