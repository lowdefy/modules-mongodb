...
The app configures nothing: the role is contributed by the module, a role page
is public without a session, and a deployment with `magicLink.enabled: false`
simply never links to the page. A
