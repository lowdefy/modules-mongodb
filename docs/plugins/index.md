...
| [CollapsibleList](collapsible-list.md)     | `list`            | Array list whose rows collapse to an `itemTitle` summary with a chevron. Backs the workflows `collapsible_list` form component.                                                    |
