...
Use it for quick views over data with a known shape but no declared layout. Use [DataDescriptions](data-descriptions.md) instead when you want explicit grouping (sections, ordering) or array iteration.
