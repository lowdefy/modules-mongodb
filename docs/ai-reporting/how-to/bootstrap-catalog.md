...
```bash
pnpm exec lowdefy-reporting-catalog --out modules/ai-reporting/catalog.draft.yaml
```
...
{
  "scripts": {
    "reporting:catalog": "lowdefy-reporting-catalog --out modules/ai-reporting/catalog.draft.yaml"
  }
}
```
...
```bash
pnpm --dir .lowdefy/server exec lowdefy-reporting-catalog --out ../../modules/ai-reporting/catalog.draft.yaml
```
...
lowdefy-reporting-catalog --include 'demo_*' --out modules/ai-reporting/catalog.draft.yaml

# Everything except operational collections
lowdefy-reporting-catalog --exclude 'user-*,log-*,*-sessions' --out modules/ai-reporting/catalog.draft.yaml
```
