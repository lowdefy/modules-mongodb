...
`designs/ai-reporting/open-query-engine/implementation-walkthrough.md`. Line
...
- The header's **⋯** is a `DropdownMenu` **compiled into the header**, wrapping the
  ...
  second implementation in the compiler**, alongside the `modules/ai-reporting/actions/`
